...
(function(){var t,i,n,e=function(t,i){return function(){return t.apply(i,arguments)}},r=[].slice;i=require("../src/plugin").Plugin,n=require("../src/utils/xmlparser").XMLParser,exports.Communicator=t=function(){"use strict";function t(){}var o,s,u;return s=null,u=null,t.get=function(t){return t&&(s=t),u||(u=new o(s))},t.destroy=function(){u=null},o=function(){function t(t){this.devices=e(this.devices,this),this.configuration=t,this.plugin=new i,this.pluginIsInstalled=this.plugin.pluginIsInstalled(),this.pluginProxy=this.plugin.el}return t.prototype.pluginIsInstalled=null,t.prototype.invoke=function(){var t,i,n;if(n=arguments[0],t=2<=arguments.length?r.call(arguments,1):[],i=this.pluginProxy[n],null!=i&&"function"==typeof i)return i.apply(this.pluginProxy,t);throw new Error("'"+n+"' function does not exist!")},t.prototype.write=function(t,i){return this.pluginProxy.hasOwnProperty(t)?(this.pluginProxy[t]=i,!0):!1},t.prototype.read=function(t){return this.pluginProxy.hasOwnProperty(t)?this.pluginProxy[t]:!1},t.prototype.busy=function(t){return null!=t&&(this._busy=t),this._busy||!1},t.prototype.isLocked=function(){return this.pluginProxy.Locked},t.prototype.unlock=function(t){var i,n=this;return this.isLocked()?(i=!1,_(t).map(function(t,e){return i||(i=n.invoke("Unlock",e,t))}),i):void 0},t.prototype.devices=function(){var t,i=this;return this.busy()?void 0:(this.busy(!0),this.unlock(),t=Q.defer(),t.promise["finally"](function(){return i.busy(!1)}),this._findDevices(t),t.promise)},t.prototype._findDevices=function(t){return this.invoke("StartFindDevices"),this._loopUntilFinishedFindingDevices(t)},t.prototype._loopUntilFinishedFindingDevices=function(t){var i=this;return this.invoke("FinishFindDevices")?t.resolve(this._parseDeviceXml()):setTimeout(function(){return i._loopUntilFinishedFindingDevices(t)},100)},t.prototype._parseDeviceXml=function(){var t,i;return t=require("../src/device").Device,i=n.parse(this.invoke("DevicesXmlString")),_(i.getElementsByTagName("Device")).map(function(i){var n,e;return n=i.getAttribute("DisplayName"),e=parseInt(i.getAttribute("Number"),10),new t(e,n)})},t}(),t}.call(this)}).call(this);
