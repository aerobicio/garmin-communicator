...
/***/ function(module, exports, require) {
	...
	(function() {
	  ...
	  Communicator = require(2).Communicator;
...
/***/ function(module, exports, require) {
	...
	(function() {
	  ...
	  Plugin = require(3).Plugin;
	
	  XMLParser = require(4).XMLParser;
...
/***/ function(module, exports, require) {
	...
	(function() {
	  ...
	  Accessor = require(7).Accessor;
	
	  FitWorkoutFactory = require(8).FitWorkoutFactory;
	
	  TcxWorkoutFactory = require(9).TcxWorkoutFactory;
...
/***/ function(module, exports, require) {
	...
	(function() {
	  ...
	  WorkoutFactory = require(10).WorkoutFactory;
	
	  FitWorkout = require(11).FitWorkout;
...
/***/ function(module, exports, require) {
	...
	(function() {
	  ...
	  TcxWorkout = require(12).TcxWorkout;
